...
function initCursor() {
    ...
    const links = document.querySelectorAll('a, button, .btn, .project-card, .skill, .social-link');
...
function initAnimations() {
    ...
    const animatedElements = document.querySelectorAll('.section-header, .hero-content, .about-content, .project-card, .timeline-item, .contact-content');
